package com.traffic.wifiapp.common.adapter.base;
...
public class BaseAdapterHelper extends RecyclerView.ViewHolder {
    ...
    public BaseAdapterHelper(Context context,View itemView) {
        super(itemView);
    ...
    public void setImageByUrl(int id, String url,int defaultRes) {
        final ImageView view = getView(id);
        Glide.with(mContext).load(url).placeholder(defaultRes).into(view);
    }
