...
import static com.traffic.wifiapp.utils.SystemUtil.goToAppSetting;

public class JumpPermissionManagement {
    private static final java.lang.String TAG = "JumpPermissionManagement";
    ...
    public static void ApplicationInfo(Activity context){
        ...
        (context).startActivityForResult(intent, SplashActivity.CHECK_PEERISSION_CODE);
    }
