package com.traffic.wifiapp.ui.view.pulltorefreshview;
...
public class PullToRefreshLayout extends RelativeLayout
{
	 ...
	 */
	public void refreshFinish( String updatetime)
	{
		int refreshResult=1;
	 ...
	 * 
	 *@param  code 1加载更多成功 0 什么也不做 -1 没有更多数据
	 */
	public void loadmoreFinish(int code)
	{
		...
		case 0:
			break;
		case NO_DATA:
			loadStateTextView.setText("没有更多数据");
			break;
		case FAIL:
		default:
			// 加载失败
	...
	private void changeState(int to)
	{
		...
		case INIT:
			...
			loadStateTextView.setText("上拉可以加载更多");
			pullUpView.clearAnimation();
			pullUpView.setVisibility(View.VISIBLE);
			break;
		case RELEASE_TO_REFRESH:
			// 释放刷新状态
			refreshStateTextView.setText("松开立即刷新");
		...
		case REFRESHING:
			...
			refreshStateTextView.setText("正在刷新数据中...");
			break;
		case RELEASE_TO_LOAD:
			// 释放加载状态
			loadStateTextView.setText("松开立即加载更多");
		...
		case LOADING:
			...
			loadStateTextView.setText("正在加载更多数据...");
			break;
		case DONE:
			// 刷新或加载完毕，啥都不做
			break;
	...
	boolean isLoadmoreViewshow=true,isRefreshViewshow=true;
	public void setCanPullUp(boolean b){
		isLoadmoreViewshow=b;
	}
	...
	private void initView()
	{
		...
		tv_time=(TextView)refreshView.findViewById(R.id.xlistview_header_time);
		...
		progressBar = (ProgressBar)loadmoreView.findViewById(R.id.loading_icon);
