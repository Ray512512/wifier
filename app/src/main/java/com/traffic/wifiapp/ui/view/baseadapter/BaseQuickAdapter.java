...
package com.traffic.wifiapp.ui.view.baseadapter;
...
import com.traffic.wifiapp.ui.view.baseadapter.animation.AlphaInAnimation;
import com.traffic.wifiapp.ui.view.baseadapter.animation.BaseAnimation;
import com.traffic.wifiapp.ui.view.baseadapter.animation.ScaleInAnimation;
import com.traffic.wifiapp.ui.view.baseadapter.animation.SlideInBottomAnimation;
import com.traffic.wifiapp.ui.view.baseadapter.animation.SlideInLeftAnimation;
import com.traffic.wifiapp.ui.view.baseadapter.animation.SlideInRightAnimation;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        ...
        if (mData.size() == 0 && getEmptyView() != null) {
            /**
    ...
    public int getItemViewType(int position) {
         ...
         */
        if (mData.size() == 0 && mEmptyEnable && getEmptyView()
                != null && position <= 2) {
            /**
            ...
            if ((mHeadAndEmptyEnable || mFootAndEmptyEnable) && position == 1) {
                 ...
                 */
                if (mHeaderLayout == null && getEmptyView() != null && mFooterLayout != null) {
                    return FOOTER_VIEW;
                    /**
                     * add headview
                     */
                } else if (mHeaderLayout != null && getEmptyView() != null) {
                    return EMPTY_VIEW;
                }
            } else if (position == 0) {
                /**
            ...
            } else if (position == 2 && (mFootAndEmptyEnable || mHeadAndEmptyEnable) && mHeaderLayout != null && getEmptyView() != null) {
                return FOOTER_VIEW;
        ...
        } else if (mData.size() == 0 && getEmptyView() != null && getItemCount() == (mHeadAndEmptyEnable ? 2 : 1) && mEmptyEnable) {
            return EMPTY_VIEW;
