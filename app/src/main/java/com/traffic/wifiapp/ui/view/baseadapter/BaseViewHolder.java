...
public class BaseViewHolder extends RecyclerView.ViewHolder {
   ...
   /* public BaseViewHolder setEmojiText(int viewId, CharSequence value) {
    ...
    public BaseViewHolder setTextNum(int viewId, CharSequence value) {
        TextView view = getView(viewId);
        if (TextUtils.isEmpty(value)){
            value = "0";
        }
    ...
    public BaseViewHolder setImageResourceCheck(int viewId, int imageChekced, int imageUnChekced,boolean isChecked) {
        ImageView view = getView(viewId);
        if (isChecked){
            view.setImageResource(imageChekced);
        }else{
            view.setImageResource(imageUnChekced);
        }
        return this;
    }
    ...
    public BaseViewHolder setBackgroundColor(int viewId, int textNoramlColor, int textPressColor, boolean isShowFirst) {
        View view = getView(viewId);
        if (isShowFirst) {
            view.setBackgroundColor(textPressColor);
        } else {
            view.setBackgroundColor(textNoramlColor);
        }
        return this;
    }
    /**
    ...
    public BaseViewHolder setTextColor(int viewId, int textNoramlColor, int textPressColor, boolean isShowFirst) {
        TextView view = getView(viewId);
        if (isShowFirst){
            view.setTextColor(textPressColor);
        }else{
            view.setTextColor(textNoramlColor);
        }
        return this;
    }
    /**
     ...
     * @return The BaseViewHolder for chaining.
     */
    public BaseViewHolder setVisibleVGone(int viewId, boolean visible) {
        View view = getView(viewId);
        view.setVisibility(visible ? View.VISIBLE : View.GONE);
        return this;
    }
    public BaseViewHolder setVisibleVIN(int viewId, boolean visible) {
        View view = getView(viewId);
